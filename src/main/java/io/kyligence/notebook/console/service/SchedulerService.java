...
public class SchedulerService {
    ...
    public void callback(String token, String scheduleOwner, String entityType, String entityId) {
        ...
        String scripts = getScript(entityType, entityId);
    ...
    private String getScript(String entityType, String entityId) {
        switch (entityType.toLowerCase()) {
            case "notebook":
                return notebookService.getNotebookScripts("admin", Integer.valueOf(entityId));
            case "workflow":
                return workflowService.getWorkflowScripts("admin", Integer.valueOf(entityId));
            default:
                return "";
        }
    }
